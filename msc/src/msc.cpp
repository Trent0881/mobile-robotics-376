// Edited by Trent Ziemer on Jan 31, 2017
// Based on code from Dr. Wyatt Newman for a class
...
int main(int argc, char **argv) {
    ...
    while(timer<time_3_sec) {
      ...
      // Below are additions from Trent

    twist_cmd.angular.z=-0.5236; // = 30 degrees per second, for 3 seconds, to make a quarter turn.
    twist_cmd.linear.x=0.0;
    timer=0.0; //reset the timer
    while(timer<time_3_sec) {
      twist_commander.publish(twist_cmd);
